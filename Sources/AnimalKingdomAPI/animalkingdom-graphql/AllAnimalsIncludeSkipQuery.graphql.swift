  ...
  public struct Data: TestSchema.SelectionSet {
    ...
    public struct AllAnimal: TestSchema.SelectionSet {
      ...
      public struct Predator: TestSchema.SelectionSet {
        ...
        public struct AsWarmBloodedIfGetWarmBlooded: TestSchema.InlineFragment {
          public let __data: DataDict
          public init(_dataDict: DataDict) { __data = _dataDict }
      ...
      public struct IfNotSkipHeightInMeters: TestSchema.InlineFragment {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }
      ...
      public struct AsCatIfGetCat: TestSchema.InlineFragment {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }
